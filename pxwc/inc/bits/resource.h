...
#if !defined _SYS_RESOURCE_ && !defined _PSXSYS_ && !defined _SYS_WAIT_
...
/* Priority limits.  */
#define PRIO_MIN   1 /* Minimum priority a process can have.  */
#define PRIO_MAX  32 /* Maximum priority a process can have.  */

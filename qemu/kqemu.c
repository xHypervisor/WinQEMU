...
{
    int v0, v1;
	printf ("Enter is_cpuid_supported\n");
#ifndef _MSC_VER
    asm volatile ("pushf\n"
                  "popl %0\n"
                  "movl %0, %1\n"
...
#endif
	printf ("Leave is_cpuid_supported, result - %i\n", (v0 != v1)?1:0);
    return 0; //return (v0 != v1);
}
#endif
...
#else
struct fpxstate fpx1 __attribute__((aligned(16)));
#endif

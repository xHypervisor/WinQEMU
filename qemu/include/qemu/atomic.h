...
#define __sync_fetch_and_or(ap, b) InterlockedOr ((LONG volatile *) (ap), (b))
#define __sync_lock_test_and_set(ap,b) _InterlockedExchange((ap), (b))
#endif
...
#else
#define atomic_read(ptr)       (*(ptr)) // NOTIFY NOTIFY
#endif
#endif
...
#else
#define atomic_set(ptr, i)     (*(ptr) = (i)) // NOTIFY NOTIFY
#endif
#endif
...
#else // NOTIFY NOTIFY
#define atomic_rcu_read(ptr)    (smp_read_barrier_depends(), *ptr)
#endif
...
#else  // NOTIFY NOTIFY
#define atomic_mb_read(ptr)  (smp_rmb(), *ptr)
#endif
#endif

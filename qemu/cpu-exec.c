...
#ifdef _MSC_VER
static int32_t nEbpBackup; // NOTIFY
//typedef long (__fastcall *pfnGeneratedFunction)(void*);
//pfnGeneratedFunction pfnTCG = NULL;
...
#if 0
					nGenCodeBuffer = &(code_gen_prologue [0]);
					__asm
					{
						//push ecx;
						mov ecx, tc_ptr;

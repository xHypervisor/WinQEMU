...
INLINE floatx80 floatx80_add( floatx80 a, floatx80 b STATUS_PARAM)
{
    ...
    return a + b;
#else
	return floatx80_add_floatx80_impl (&a, &b);
#endif
}
INLINE floatx80 floatx80_sub( floatx80 a, floatx80 b STATUS_PARAM)
{
    ...
    return a - b;
#else
	return floatx80_sub_floatx80_impl (&a, &b);
#endif
}
INLINE floatx80 floatx80_mul( floatx80 a, floatx80 b STATUS_PARAM)
{
    ...
    return a * b;
#else
	return floatx80_mul_floatx80_impl (&a, &b);
#endif
}
INLINE floatx80 floatx80_div( floatx80 a, floatx80 b STATUS_PARAM)
{
    ...
    return a / b;
#else
	return floatx80_div_floatx80_impl (&a, &b);
#endif
}
...
INLINE int floatx80_eq( floatx80 a, floatx80 b STATUS_PARAM)
{
    ...
    return a == b;
#else
	return floatx80_isequal_floatx80_impl (&a, &b);
#endif
}
INLINE int floatx80_le( floatx80 a, floatx80 b STATUS_PARAM)
{
    ...
    return a <= b;
#else
	return floatx80_isle_floatx80_impl (&a, &b);
#endif
}
INLINE int floatx80_lt( floatx80 a, floatx80 b STATUS_PARAM)
{
    ...
    return a < b;
#else
	return floatx80_isl_floatx80_impl (&a, &b);
#endif
}
INLINE int floatx80_eq_signaling( floatx80 a, floatx80 b STATUS_PARAM)
{
    ...
    return a <= b && a >= b;
#else
	return floatx80_isle_floatx80_impl (&a, &b) && floatx80_isge_floatx80_impl (&a, &b);
#endif
}
INLINE int floatx80_le_quiet( floatx80 a, floatx80 b STATUS_PARAM)
{
    ...
    return islessequal(a, b);
#else
	return islessequal(floatx80_to_float64_impl (&a), floatx80_to_float64_impl (&b));
#endif
}
INLINE int floatx80_lt_quiet( floatx80 a, floatx80 b STATUS_PARAM)
{
    ...
    return isless(a, b);
#else
	return isless(floatx80_to_float64_impl (&a), floatx80_to_float64_impl(&b));
#endif
}
INLINE int floatx80_unordered( floatx80 a, floatx80 b STATUS_PARAM)
{
    ...
    return isunordered(a, b);
#else
	return isunordered(floatx80_to_float64_impl (&a), floatx80_to_float64_impl (&b));
#endif
}
...
INLINE floatx80 floatx80_is_infinity(floatx80 a)
{
    ...
    return fpclassify(a) == FP_INFINITE;
#else
	return floatx80_from_int32_impl (fpclassify (floatx80_to_float64_impl (&a)) == FP_INFINITE);
#endif
}
...
INLINE floatx80 floatx80_is_neg(floatx80 a)
{
    floatx80u u;
    u.f = a;
    return floatx80_from_int32_impl (u.i.high >> 15);
}
...
INLINE floatx80 floatx80_is_zero(floatx80 a)
{
    ...
    return fpclassify(a) == FP_ZERO;
#else
	return floatx80_from_int32_impl (fpclassify(floatx80_to_float64_impl (&a)) == FP_ZERO);
#endif
}
...
INLINE floatx80 floatx80_scalbn(floatx80 a, int n)
{
    ...
    return scalbnl(a, n);
#else
	return floatx80_from_int32_impl (scalbnl(floatx80_to_float64_impl (&a), n));
#endif
}

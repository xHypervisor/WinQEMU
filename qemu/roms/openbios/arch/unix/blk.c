...
static void
blk_close( ATTRIBUTE_UNUSED blk_data_t *pb )
{
...
/* ( -- bs ) */
static void
blk_block_size( ATTRIBUTE_UNUSED blk_data_t *pb )
{
	PUSH( 512 );
}
...
/* ( -- maxbytes ) */
static void
blk_max_transfer( ATTRIBUTE_UNUSED blk_data_t *pb )
{
	PUSH( 1024*1024 );
}

static void
blk_initialize( ATTRIBUTE_UNUSED blk_data_t *pb )
{
	fword("is-deblocker");
}
